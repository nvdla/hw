...
//| generated by viva: memresp_fifo.vcp --> memresp_fifo.v

//| /home/nvtools/engr/2012/10/08_03_42_08/nvtools/viva/viva -e 'v sv vt gv vlib bvrl NULL' -y '../../../vrtl/crab/cd100 ../../../vrtl/common/cd100 ../../../arrays/cd100 ./rams/model ../../../array_lib/mbist/lsd/cd100 ../../../vlib/cd100/cells ../../../vlib/cd100 /home/scratch.abilashs_denver/abilashs_denver_lsu/dev/cpu/branches/cd100_pd/main/sdf100/inf/nvtools/1.0/nvtools/rtl/vlib /home/nvtools/engr/2013/03/22_09_38_31/nvtools/assertions /home/tools/synopsys/syn_2011.09/dw/sim_ver' -i '../../../vrtl/tlb/cd100 ../../../array_lib/mbist/lsd/cd100 ../../../vlib/cd100 ../../../vlib/cd100/cells . ../../../vlib/cd100 ../../../vlib/cd100_libs ../../../include/cd100 ../../../vrtl/include/cd100 ../../../vlib/cd100 /home/nvtools/engr/2013/03/22_09_38_31/nvtools/assertions /home/denver/release/hw/validation/tools/sknobs/cl19294571_sp1/lib/verilog ../../../vrtl/include/cd100/lib_cell_files' -p '. /home/scratch.abilashs_denver/abilashs_denver_lsu/dev/cpu/branches/cd100_pd/dev/cpu/denver/rtlbuild/2.0/lib/viva /home/scratch.abilashs_denver/abilashs_denver_lsu/dev/cpu/branches/cd100_pd/main/sdf100/inf/nvtools/1.0/nvtools/viva_plugins' -d SPEC_PERL_DIR=../../../defs/perldb/cd100 -v ../../../vlib/cd100/cells/tsmc_udp.vlib -v ../../../vlib/cd100/library_primitives.vlib -xcpp /home/gnu/gcc-2.95.3/bin/cpp -d NV_DENVER_MCORES2 -d BEHAVIORAL_AUTOPD_DEFAULT memresp_fifo.vcp -o memresp_fifo.v

// generated by vcp: memresp_fifo.vx --> memresp_fifo.vcp

//
// AUTOMATICALLY GENERATED -- DO NOT EDIT OR CHECK IN
//
// fifogen -m memresp_fifo -d 448 -w 512 -ram ff -wr_empty [Chosen ram type: ff - fifogen_flops (user specified, thus no other ram type is allowed)]
// chip config vars: fifogen_uses_ramgen=1  fifogen_perfmon_histogram_defined=1  fifogen_use1'b0=1  fifogen_no_pound_delay=1  fifogen_force_wr_reg_gated=1  fifogen_no_force_reset=1  fifogen_no_timescale=  system_verilog=1  fifogen_viva_parsed=1  fifogen_ram_variant_all=1  fifogen_requires_full_throughput=1  fifogen_rollpli_seedset="auto" 
//
...
`endif
    ...
    if ( $test$plusargs( "memresp_fifo_wr_limit" ) ) begin
        wr_limit_override = 1;
        $GetArgVal( wr_limit_override_value, "memresp_fifo_wr_limit", 0 );
    end
end
...
`endif
    ...
    if ( $test$plusargs( "memresp_fifo_fifo_stall_probability" ) ) begin
        $GetArgVal( stall_probability, "memresp_fifo_fifo_stall_probability", 0 );
    end else if ( $test$plusargs( "default_fifo_stall_probability" ) ) begin
        $GetArgVal( stall_probability, "default_fifo_stall_probability", 0 );
    end

    if ( $test$plusargs( "memresp_fifo_fifo_stall_cycles_min" ) ) begin
        $GetArgVal( stall_cycles_min, "memresp_fifo_fifo_stall_cycles_min", 0 );
    end else if ( $test$plusargs( "default_fifo_stall_cycles_min" ) ) begin
        $GetArgVal( stall_cycles_min, "default_fifo_stall_cycles_min", 0 );
    end

    if ( $test$plusargs( "memresp_fifo_fifo_stall_cycles_max" ) ) begin
        $GetArgVal( stall_cycles_max, "memresp_fifo_fifo_stall_cycles_max", 0 );
    end else if ( $test$plusargs( "default_fifo_stall_cycles_max" ) ) begin
        $GetArgVal( stall_cycles_max, "default_fifo_stall_cycles_max", 0 );
    end
...
//| ::testpoint -autogen true -name "Fifo Full" -clk clk -reset wr_testpoint_reset_ wr_count==448;
...
`endif
    ...
    // TESTPOINT_END
//| ::testpoint -autogen true -name "Fifo Full and wr_req" -clk clk -reset wr_testpoint_reset_ wr_count==448 && wr_req;
//VCS coverage off
`ifndef DISABLE_TESTPOINTS
`ifdef COVER
    // TESTPOINT_START
...
//| ::testpoint -autogen true -name "Fifo not empty and rd_busy" -clk clk -reset rd_testpoint_reset_ rd_req && rd_busy;
//VCS coverage off
`ifndef DISABLE_TESTPOINTS
`ifdef COVER
    // TESTPOINT_START
...
//| ::testpoint -autogen true -name "Fifo non-empty to empty to non-empty" -clk clk -reset rd_testpoint_reset_ testpoint_non_empty_to_empty_to_non_empty_reached; 
//VCS coverage off
`ifndef DISABLE_TESTPOINTS
`ifdef COVER
    // TESTPOINT_START
