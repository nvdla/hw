...
`endif
    ...
    if ( $test$plusargs( "raddr_fifo_wr_limit" ) ) begin
        wr_limit_override = 1;
        $GetArgVal( wr_limit_override_value, "raddr_fifo_wr_limit", 0 );
    end
end
...
`endif
    ...
    if ( $test$plusargs( "raddr_fifo_fifo_stall_probability" ) ) begin
        $GetArgVal( stall_probability, "raddr_fifo_fifo_stall_probability", 0 );
    ...
    if ( $test$plusargs( "raddr_fifo_fifo_stall_cycles_min" ) ) begin
        $GetArgVal( stall_cycles_min, "raddr_fifo_fifo_stall_cycles_min", 0 );
    ...
    if ( $test$plusargs( "raddr_fifo_fifo_stall_cycles_max" ) ) begin
        $GetArgVal( stall_cycles_max, "raddr_fifo_fifo_stall_cycles_max", 0 );
...
//| ::testpoint -autogen true -name "Fifo Full" -clk clk -reset wr_testpoint_reset_ wr_count==384;
...
`endif
    ...
    // TESTPOINT_END
//| ::testpoint -autogen true -name "Fifo Full and wr_req" -clk clk -reset wr_testpoint_reset_ wr_count==384 && wr_req;
//VCS coverage off
`ifndef DISABLE_TESTPOINTS
`ifdef COVER
    // TESTPOINT_START
