...
`endif
    ...
    if ( $test$plusargs( "wstrb_fifo_wr_limit" ) ) begin
        wr_limit_override = 1;
        $GetArgVal( wr_limit_override_value, "wstrb_fifo_wr_limit", 0 );
    end
end
...
`endif
    ...
    if ( $test$plusargs( "wstrb_fifo_fifo_stall_probability" ) ) begin
        $GetArgVal( stall_probability, "wstrb_fifo_fifo_stall_probability", 0 );
    ...
    if ( $test$plusargs( "wstrb_fifo_fifo_stall_cycles_min" ) ) begin
        $GetArgVal( stall_cycles_min, "wstrb_fifo_fifo_stall_cycles_min", 0 );
    ...
    if ( $test$plusargs( "wstrb_fifo_fifo_stall_cycles_max" ) ) begin
        $GetArgVal( stall_cycles_max, "wstrb_fifo_fifo_stall_cycles_max", 0 );
