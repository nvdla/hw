...
'read_reg_poll_interval_clocks' => [ '3e8', 'Master Sequencer Read Poll Interval (1000)', 10 ],
'read_reg_timeout_clocks' => [ '2710', 'Master Sequencer Read Timeout', 11 ],
...
'read_reg_poll_retries' => [ 'fa', 'Master Sequencer Read Polls (250)', 15 ],
