...
`endif
    ...
    if ( $test$plusargs( "waddr_fifo_wr_limit" ) ) begin
        wr_limit_override = 1;
        $GetArgVal( wr_limit_override_value, "waddr_fifo_wr_limit", 0 );
    end
end
...
`endif
    ...
    if ( $test$plusargs( "waddr_fifo_fifo_stall_probability" ) ) begin
        $GetArgVal( stall_probability, "waddr_fifo_fifo_stall_probability", 0 );
    ...
    if ( $test$plusargs( "waddr_fifo_fifo_stall_cycles_min" ) ) begin
        $GetArgVal( stall_cycles_min, "waddr_fifo_fifo_stall_cycles_min", 0 );
    ...
    if ( $test$plusargs( "waddr_fifo_fifo_stall_cycles_max" ) ) begin
        $GetArgVal( stall_cycles_max, "waddr_fifo_fifo_stall_cycles_max", 0 );
