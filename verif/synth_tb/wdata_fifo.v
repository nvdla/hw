...
`endif
    ...
    if ( $test$plusargs( "wdata_fifo_wr_limit" ) ) begin
        wr_limit_override = 1;
        $GetArgVal( wr_limit_override_value, "wdata_fifo_wr_limit", 0 );
    end
end
...
`endif
    ...
    if ( $test$plusargs( "wdata_fifo_fifo_stall_probability" ) ) begin
        $GetArgVal( stall_probability, "wdata_fifo_fifo_stall_probability", 0 );
    ...
    if ( $test$plusargs( "wdata_fifo_fifo_stall_cycles_min" ) ) begin
        $GetArgVal( stall_cycles_min, "wdata_fifo_fifo_stall_cycles_min", 0 );
    ...
    if ( $test$plusargs( "wdata_fifo_fifo_stall_cycles_max" ) ) begin
        $GetArgVal( stall_cycles_max, "wdata_fifo_fifo_stall_cycles_max", 0 );
...
//| ::testpoint -autogen true -name "Fifo Full" -clk clk -reset wr_testpoint_reset_ wr_count==64;
...
`endif
    ...
    // TESTPOINT_END
//| ::testpoint -autogen true -name "Fifo Full and wr_req" -clk clk -reset wr_testpoint_reset_ wr_count==64 && wr_req;
//VCS coverage off
`ifndef DISABLE_TESTPOINTS
`ifdef COVER
    // TESTPOINT_START
