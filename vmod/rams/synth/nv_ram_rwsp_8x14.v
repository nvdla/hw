// nv_ram_rwsp_8x14: synthesizable model wrapper
...
nv_ram_rwsp_8x14_logic #(FORCE_CONTENTION_ASSERTION_RESET_ACTIVE) r_nv_ram_rwsp_8x14 (
...
if (shadow_written[0]) force r_nv_ram_rwsp_8x14.Wdata_row0 = shadow_mem[0][13:0];
if (shadow_written[0]) force r_nv_ram_rwsp_8x14.latchNet_G_en0 = 1'b1;
if (shadow_written[1]) force r_nv_ram_rwsp_8x14.Wdata_row1 = shadow_mem[1][13:0];
if (shadow_written[1]) force r_nv_ram_rwsp_8x14.latchNet_G_en1 = 1'b1;
if (shadow_written[2]) force r_nv_ram_rwsp_8x14.Wdata_row2 = shadow_mem[2][13:0];
if (shadow_written[2]) force r_nv_ram_rwsp_8x14.latchNet_G_en2 = 1'b1;
if (shadow_written[3]) force r_nv_ram_rwsp_8x14.Wdata_row3 = shadow_mem[3][13:0];
if (shadow_written[3]) force r_nv_ram_rwsp_8x14.latchNet_G_en3 = 1'b1;
if (shadow_written[4]) force r_nv_ram_rwsp_8x14.Wdata_row4 = shadow_mem[4][13:0];
if (shadow_written[4]) force r_nv_ram_rwsp_8x14.latchNet_G_en4 = 1'b1;
if (shadow_written[5]) force r_nv_ram_rwsp_8x14.Wdata_row5 = shadow_mem[5][13:0];
if (shadow_written[5]) force r_nv_ram_rwsp_8x14.latchNet_G_en5 = 1'b1;
if (shadow_written[6]) force r_nv_ram_rwsp_8x14.Wdata_row6 = shadow_mem[6][13:0];
if (shadow_written[6]) force r_nv_ram_rwsp_8x14.latchNet_G_en6 = 1'b1;
if (shadow_written[7]) force r_nv_ram_rwsp_8x14.Wdata_row7 = shadow_mem[7][13:0];
if (shadow_written[7]) force r_nv_ram_rwsp_8x14.latchNet_G_en7 = 1'b1;

#1;

// releasing enables for Latch_Array
release r_nv_ram_rwsp_8x14.latchNet_G_en0;
release r_nv_ram_rwsp_8x14.latchNet_G_en1;
release r_nv_ram_rwsp_8x14.latchNet_G_en2;
release r_nv_ram_rwsp_8x14.latchNet_G_en3;
release r_nv_ram_rwsp_8x14.latchNet_G_en4;
release r_nv_ram_rwsp_8x14.latchNet_G_en5;
release r_nv_ram_rwsp_8x14.latchNet_G_en6;
release r_nv_ram_rwsp_8x14.latchNet_G_en7;

#1;

// releasing data inputs for Latch_Array
release r_nv_ram_rwsp_8x14.Wdata_row0;
release r_nv_ram_rwsp_8x14.Wdata_row1;
release r_nv_ram_rwsp_8x14.Wdata_row2;
release r_nv_ram_rwsp_8x14.Wdata_row3;
release r_nv_ram_rwsp_8x14.Wdata_row4;
release r_nv_ram_rwsp_8x14.Wdata_row5;
release r_nv_ram_rwsp_8x14.Wdata_row6;
release r_nv_ram_rwsp_8x14.Wdata_row7;
...
// probing Latch_Array
if (row == 0) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row0;
if (row == 1) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row1;
if (row == 2) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row2;
if (row == 3) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row3;
if (row == 4) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row4;
if (row == 5) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row5;
if (row == 6) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row6;
if (row == 7) data[13:0] = r_nv_ram_rwsp_8x14.LatchArray_row7;
    probe_mem_val = data;
...
integer bitnum;
begin
  random_num = rflip.rollpli(0, 112);
  row = random_num / 14;
