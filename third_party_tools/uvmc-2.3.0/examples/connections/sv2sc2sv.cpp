...
//-----------------------------------------------------------------------------
// Title: UVMC Connection Example - Basic Testbench, SC side
//
...
// See <UVMC Connection Example - Basic Testbench, SV side> for the SV portion
// of this example.
//
...
//   string "stimulus". During elaboration, UVMC will connect this port with
...
//
// - Registers the consumer's ~ap~ port with UVMC using the lookup
//   string "analysis". During elaboration, UVMC will connect this port with
//   a port registered with the same lookup string. In this example, the
//   match will occur with the scoreboard's ~actual_in~ analysis export on
//   the SV side.
// 
