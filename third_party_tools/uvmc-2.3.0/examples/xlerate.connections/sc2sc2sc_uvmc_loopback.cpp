//============================================================================
// @(#) $Id: sc2sc2sc_uvmc_loopback.cpp 1268 2014-12-01 22:03:42Z jstickle $
//============================================================================
...
//-----------------------------------------------------------------------------
// Title: SC-to-SV-to-SC loopback, default TLM GP converters
//
...
class top : public sc_module {
  ...
  public:
      ...
      prod( "prod" ), loop( "loop" )
    {
		...
		uvmc_connect(prod.in,"43");
        uvmc_connect(loop.in,"42");
        uvmc_connect(loop.out,"43");
    }
};
