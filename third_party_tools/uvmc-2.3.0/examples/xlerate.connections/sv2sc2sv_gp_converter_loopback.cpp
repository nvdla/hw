//============================================================================
// @(#) $Id: sv2sc2sv_gp_converter_loopback.cpp 1254 2014-11-21 20:12:17Z jstickle $
//============================================================================
...
class top : public sc_module {
  ...
  public:
    ...
    top( sc_module_name nm ) : sc_module( nm ), loop( "loop" ) {
        uvmc_connect<uvmc_tlm_gp_converter>(loop.in,"42");
        uvmc_connect<uvmc_tlm_gp_converter>(loop.out,"43");
  }
};
